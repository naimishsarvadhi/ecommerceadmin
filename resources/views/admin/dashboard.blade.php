                ...
                <div class="col-md-7 col-lg-8 col-sm-12 col-xs-12">
                    <div class="white-box">
                        ...
                        <ul class="list-inline text-center">
                            ...
                            <li>
                                <h5><i class="fa fa-circle m-r-5" style="color: #b4becb;"></i>iMac</h5>
                            </li>
                        </ul>
                ...
                <div class="col-md-5 col-lg-4 col-sm-12 col-xs-12">
                    <div class="white-box">
                        ...
                        <ul class="list-inline m-t-30 text-center">
                            <li class="p-r-20">
                                <h5 class="text-muted"><i class="fa fa-circle" style="color: #fb9678;"></i> Order
                                </h5>
                                <h4 class="m-b-0">8500</h4>
                            </li>
                            <li class="p-r-20">
                                <h5 class="text-muted"><i class="fa fa-circle" style="color: #01c0c8;"></i> Pending
                                </h5>
                            ...
                            <table class="table product-overview">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>#85457898</td>
                                        <td>
                                            <img src="{{ asset('assets/plugins/images/chair.jpg') }}" alt="iMac"
                                                width="80">
                                        </td>
                                        <td>Rounded Chair</td>
                                        <td>20</td>
                                    ...
                                    <tr>
                                        ...
                                        <td>#95457898</td>
                                        <td>
                                            <img src="{{ asset('assets/plugins/images/chair2.jpg') }}" alt="iPhone"
                                                width="80">
                                        </td>
                                        <td>Wooden Chair</td>
                                        <td>25</td>
                                    ...
                                    <tr>
                                        ...
                                        <td>#68457898</td>
                                        <td>
                                            <img src="{{ asset('assets/plugins/images/chair3.jpg') }}" alt="apple_watch"
                                                width="80">
                                        </td>
                                        <td>Gray Chair</td>
                                        <td>12</td>
                                    ...
                                    <tr>
                                        ...
                                        <td>#45457898</td>
                                        <td>
                                            <img src="{{ asset('assets/plugins/images/chair4.jpg') }}" alt="mac_mouse"
                                                width="80">
                                        </td>
