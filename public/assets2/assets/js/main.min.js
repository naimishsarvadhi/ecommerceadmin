    ...
    var t = {
        ...
        mobileMenu: function() {
            e(".mmenu-btn").on("click", function(t) {
                var o = e(this).closest("li"),
                    i = o.find("ul").eq(0),
                    n = o.siblings(".open");
                n.find("ul").eq(0).slideUp(300, function() { n.removeClass("open") }), o.hasClass("open") ? i.slideUp(300, function() { o.removeClass("open") }) : i.slideDown(300, function() { o.addClass("open") }), t.stopPropagation(), t.preventDefault()
            })
        },
        ...
        lightBox: function() {
            ...
            i.each(function() { o.push({ src: e(this).attr("data-zoom-image") }) }), e(".prod-full-screen").click(function(t) {
                var n;
                n = t.currentTarget.closest(".product-slider-container") ? (e(".product-single-carousel").data("owl.carousel").current() + i.length) % i.length : e(t.currentTarget).closest(".product-item").index(), e.magnificPopup.open({ items: o, navigateByImgClick: !0, type: "image", gallery: { enabled: !0 } }, n)
        ...
        ajaxLoadProduct: function() {
            ...
            o.click(function(i) {
                i.preventDefault(), e(this).text("Loading ..."), e.ajax({
                    ...
                    success: function(i) {
                        var n = e(i);
                        setTimeout(function() { n.appendTo(".product-ajax-grid"), o.text("Load More"), ++t >= 2 && o.hide() }, 350)
                    },
