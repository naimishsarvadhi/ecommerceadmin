            ...
            ! function() {
                if (!_.data("alreadyinitialized")) {
                    ...
                    "" !== (u = t.extend({}, o, C, (a = {}, t.each(s, function(t, e) {
                        ...
                        }(), w = { down: t(".bootstrap-touchspin-down", g), up: t(".bootstrap-touchspin-up", g), input: t("input", g), prefix: t(".bootstrap-touchspin-prefix", g).addClass(u.prefix_extraclass), postfix: t(".bootstrap-touchspin-postfix", g).addClass(u.postfix_extraclass) }, n(), _.on("keydown.touchspin", function(t) {
                            var e = t.keyCode || t.which;
                            38 === e ? ("up" !== W && (h(), c()), t.preventDefault()) : 40 === e && ("down" !== W && (l(), p()), t.preventDefault())
                        }), _.on("keyup.touchspin", function(t) {
                            var e = t.keyCode || t.which;
                            38 === e ? d() : 40 === e && d()
                        }), _.on("blur.touchspin", function() { r(), _.val(u.callback_after_calculation(_.val())) }), w.down.on("keydown", function(t) {
                            var e = t.keyCode || t.which;
                        ...
                        }), _.on("touchspin.uponce", function() { d(), h() }), _.on("touchspin.downonce", function() { d(), l() }), _.on("touchspin.startupspin", function() { c() }), _.on("touchspin.startdownspin", function() { p() }), _.on("touchspin.stopspin", function() { d() }), _.on("touchspin.updatesettings", function(e, i) {
                            ! function(e) {
                                (function(e) {
                                    if (u = t.extend({}, u, e), e.postfix) { 0 === _.parent().find(".bootstrap-touchspin-postfix").length && f.insertAfter(_), _.parent().find(".bootstrap-touchspin-postfix .input-group-text").text(e.postfix) }
                                    if (e.prefix) { 0 === _.parent().find(".bootstrap-touchspin-prefix").length && m.insertBefore(_), _.parent().find(".bootstrap-touchspin-prefix .input-group-text").text(e.prefix) }
                                    n()
                                })(e), r();
                                var i = w.input.val();
...
function(t) { "function" == typeof define && define.amd ? define(["jquery"], t) : t("object" == typeof exports ? require("jquery") : window.jQuery || window.Zepto) }(function(t) {
    ...
    w.prototype = {
        ...
        close: function() { e.isOpen && (b(h), e.isOpen = !1, e.st.removalDelay && !e.isLowIE && e.supportsTransition ? (e._addClassToMFP(f), setTimeout(function() { e._close() }, e.st.removalDelay)) : e._close()) },
        _close: function() {
            b(a);
            var i = f + " " + m + " ";
        ...
        appendContent: function(t, i) { e.content = t, t ? e.st.showCloseBtn && e.st.closeBtnInside && !0 === e.currTemplate[i] ? e.content.find(".mfp-close").length || e.content.append(_()) : e.content = t : e.content = "", b("BeforeAppend"), e.container.addClass("mfp-" + i + "-holder"), e.contentContainer.append(e.content) },
        parseEl: function(i) {
            var o, s = e.items[i];
        ...
        updateStatus: function(t, o) {
            if (e.preloader) {
                ...
                b("UpdateStatus", s), t = s.status, o = s.text, e.preloader.html(o), e.preloader.find("a").on("click", function(t) { t.stopImmediatePropagation() }), e.container.addClass("mfp-s-" + t), i = t
            }
        },
    ...
    t.magnificPopup.registerModule(k, {
        ...
        proto: {
            initInline: function() { e.types.push(k), z(a + "." + k, function() { L() }) },
    ...
    t.magnificPopup.registerModule(I, {
        ...
        proto: {
            initAjax: function() { e.types.push(I), H = e.st.ajax.cursor, z(a + "." + I, O), z("BeforeChange." + I, O) },
            getAjax: function(i) {
                ...
                var o = t.extend({
                    ...
                    success: function(o, s, n) {
                        var r = { data: o, xhr: n };
                        b("ParseAjax", r), e.appendContent(t(r.data), I), i.finished = !0, $(), e._setFocus(), setTimeout(function() { e.wrap.addClass(m) }, 16), e.updateStatus("ready"), b("AjaxContentAdded")
                    },
                    error: function() { $(), i.finished = i.loadError = !0, e.updateStatus("error", e.st.ajax.tError.replace("%url%", i.src)) }
                }, e.st.ajax.settings);
    ...
    t.magnificPopup.registerModule("image", {
        ...
        proto: {
            ...
            _onImageHasSize: function(t) { t.img && (t.hasSize = !0, P && clearInterval(P), t.isCheckingImgSize = !1, b("ImageHasSize", t), t.imgHidden && (e.content && e.content.removeClass("mfp-loading"), t.imgHidden = !1)) },
                ...
                if (i.enabled && e.supportsTransition) {
                    ...
                    z("BuildControls" + o, function() {
                        if (e._allowZoom()) {
                            ...
                            (n = l(t)).css(e._getOffset()), e.wrap.append(n), s = setTimeout(function() { n.css(e._getOffset(!0)), s = setTimeout(function() { p(), setTimeout(function() { n.remove(), t = n = null, b("ZoomAnimationEnded") }, 16) }, r) }, 16)
                        }
                    }), z(h + o, function() {
                        if (e._allowZoom()) {
        ...
        proto: {
            ...
            _preloadItem: function(i) {
                if (i = j(i), !e.items[i].preloaded) {
                    var o = e.items[i];
                    o.parsed || (o = e.parseEl(i)), b("LazyLoad", o), "image" === o.type && (o.img = t('<img class="mfp-img" />').on("load.mfploader", function() { o.hasSize = !0 }).on("error.mfploader", function() { o.hasSize = !0, o.loadError = !0, b("LazyLoadError", o) }).attr("src", o.src)), o.preloaded = !0
                }
            }
        }
    });
...
function() {
    ...
    function t(o) { this.options = e.extend({}, i.defaults, t.defaults, o), this.element = this.options.element, this.$element = e(this.element), this.createWrapper(), this.createWaypoint() }
    var e = window.jQuery,
        i = window.Waypoint;
        ...
        e.fn.themePin = function(t) {
            ...
            var l = function() {
                    for (var i = 0, o = s.length; i < o; i++) {
                        var a = s[i];
                        if (t.minWidth && r.width() <= t.minWidth) a.parent().is(".pin-wrapper") && a.unwrap(), a.css({ width: "", left: "", top: "", position: "" }), t.activeClass && a.removeClass(t.activeClass), a.removeClass("sticky-transition"), a.removeClass("sticky-absolute"), n = !0;
                        else {
                            n = !1;
            ...
            }), e(window).on("smartresize", function() { l(), p() }), e(window).on("touchmove scroll", p), l(), e(this).bind("recalc.pin", function() { l(), p() }), this
        }, t = t || {};
        var i = function(t, e) { return this.initialize(t, e) };
        i.defaults = { autoInit: !1, minWidth: 767, activeClass: "sticky-active", padding: { top: 0, bottom: 0 }, offsetTop: 0, offsetBottom: 0, autoFit: !1, fitToBottom: !1 }, i.prototype = {
            ...
            build: function() {
                ...
                return t.themePin(this.options), e(window).on("resize", function() {
                    setTimeout(function() { t.trigger("recalc.pin") }, 800);
                    var e = t.parent();
                    t.outerWidth(e.width()), "fixed" == t.css("position") && t.css("left", e.offset().left)
                }), this
            }
        }, e.extend(t, { Sticky: i }), e.fn.themeSticky = function(i) { return this.map(function() { var o = e(this); return o.data("__sticky") ? (o.trigger("recalc.pin"), setTimeout(function() { o.trigger("recalc.pin") }, 800), o.data("__sticky")) : new t.Sticky(o, i) }) }
